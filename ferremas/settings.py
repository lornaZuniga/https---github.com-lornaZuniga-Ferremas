...
SECRET_KEY = 'django-insecure-2tp%m3(vmz!namcncjem$faxp+hlg%+7p_%4i+u6)+2u7al*%c'
...
INSTALLED_APPS = [
    ...
    'products',
    'rest_framework',
    'frontend',  # LA app frontend esta registrada aquí
    'store'
]
...
DATABASES = {
    'default': {
        ...
        'NAME': 'ferremas_db',          #  nombre de BD
        'USER': 'ferremas_user',     #  usuario MySQL
